...
model_data::model_data(int argc,char * argv[]) : ad_comm(argc,argv)
{
 ...
 ad_comm::change_datafile_name("PWS_ASA(covariate_se).ctl");   
  covariate_se.allocate(1,nyr,1,n_mor_covs,"covariate_se");
  age0_cov_se.allocate(1,nyr,1,n_age0_covs,"age0_cov_se");
 M_cov_model=1;
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  loginit_pop.allocate(1,5,3,9,ph_init_pop,"loginit_pop");
  egg_add.allocate(0.00001,0.5,ph_eggAdd,"egg_add");
  logmdm_c.allocate(2.3,7,ph_mdm,"logmdm_c");
  m_add.allocate(0.0,0.6,ph_mdmAdd,"m_add");
  hydADFG_q.allocate(-5,5,ph_hyd1,"hydADFG_q");
  hydADFG_add.allocate(0.0,0.6,ph_hydAdd1,"hydADFG_add");
  hydPWSSC_q.allocate(-5,5,ph_hyd2,"hydPWSSC_q");
  hydPWSSC_add.allocate(0.00001,0.6,ph_hydAdd2,"hydPWSSC_add");
  annual_age0devs.allocate(1,rec_cov_counter_age0devs,1,nyr_tobefit,-5,5,ph_age0devs,"annual_age0devs");
  log_MeanAge0.allocate(2,9,ph_meanage0,"log_MeanAge0");
  ...
  beta_age0.allocate(1,rec_cov_counter,-5,5,ph_betaage0,"beta_age0");
  beta_mortality.allocate(1,mor_cov_counter,-40,40,ph_betamortality,"beta_mortality");
  ...
  beta_age0_offset.allocate(1,rec_cov_counter,-10,10,ph_age0_offset,"beta_age0_offset");
  beta_mortality_offset.allocate(1,mor_cov_counter,-7,7,ph_mortality_offset,"beta_mortality_offset");
  sigma_age0covar.allocate(1,rec_cov_counter_age0devs,0.0001,2,ph_sigma_age0covar,"sigma_age0covar");
  sigma_morcovar.allocate(1,mor_cov_counter,0,2,ph_sigma_morcovar,"sigma_morcovar");
  ...
  #endif
  beta_mort_prior.allocate("beta_mort_prior");
  #ifndef NO_AD_INITIALIZE
